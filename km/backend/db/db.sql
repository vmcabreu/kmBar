...
CREATE TABLE IF NOT EXISTS comanda_detalle (
  ...
  FOREIGN KEY (comida_id) REFERENCES comida(id) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (bebida_id) REFERENCES bebidas(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
('Matusalén 7 años', 'Bebidas alcohólicas', 5.50),
('Matusalén 15 años', 'Bebidas alcohólicas', 6.50),
('Johnnie Walker', 'Bebidas alcohólicas', 4.00),
('Vodka', 'Bebidas alcohólicas', 4.00),
('Tanqueray', 'Bebidas alcohólicas', 5.00),
('Tanqueray Lime', 'Bebidas alcohólicas', 5.00),
...
('Aquarius', 'Refrescos', 1.60),
('Nestea', 'Refrescos', 1.60),
('Appletiser', 'Refrescos', 1.60),
('Power King', 'Refrescos', 1.60),
('Tónica', 'Refrescos', 1.50),
('Tónica fresa', 'Refrescos', 1.50),
('Apaga y vamonos (Blanco Afrutado)', 'Vinos', 2.00),
('De la casa (Blanco/Tinto)', 'Vinos', 1.00),
...
('Pulguitas', 'Bocadillos', 1.80),
('Sandwich Mixto', 'Bocadillos', 1.80),
('Sandwich de Pollo', 'Bocadillos', 2.50),
('Croissant Mixto', 'Bocadillos', 2.40),
('Croissant Pollo', 'Bocadillos', 3.20),
('Mechada (con queso y alioli)', 'Bocadillos', 3.00),
('Tortilla (con queso y alioli)', 'Bocadillos', 3.00),
('Jamón Serrano/Pata', 'Bocadillos', 2.80),
...
('Realejo Bajo (queso, jamón, pollo, tortilla y alioli)', 'Bocadillos', 4.00),
...
('Tartas', 'Chucheria', 2.50),
('Dulces', 'Chucheria', 1.40),
('Extra', 'Extra', 0.30),
